<?php
/**
 * admin/RendeloAdminController
 * @class RendeloAdminController
 * 
 */
 ...
 * 
 **/
class RendeloAdminController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Rendelo']))
		{
			$model->attributes=$_POST['Rendelo'];
	...
	{
		$dataProvider=new CActiveDataProvider('Rendelo');
	 ...
	 * @param Rendelo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rendelo-form')
		{

<?php
/**
 * KepekAdminController
 * @class KepekAdminController
 * 
 */
 
 /**
 * @brief admin/KepekAdmin => Kepek tábla (csak a képhez tartoró adatok) karbantartás
 * 
 ...
 * 
 **/
class KepekAdminController extends Controller
{
	/**

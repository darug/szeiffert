 ...
 * @file admin/ContentController.php
 * @class ContentAdminController
 * 
 */
 
 /**
 * @brief admin/Content => Content tábla karbantartás
 * 
 ...
 * Az ovábbiak csak az admin számára elérhetők:
 * - allupdate($id), amely az adott rekordtól az azonos name rekordok tartalmát az első tartalmára módosítja 
 * - error, amely hiba esetén hibaüzenetet küld 
 * 
 * @todo: admin/ContentController 19. sortól a listát befejezni @file
 **/
...
class ContentController extends Controller
{
	 ...
	 */
	public $layout='//layouts/admin'; /**< az oldal kinézetét meghatározó fájl */
	public $llink;
	public $orvos;
	public $kerlist;
		...
		if(isset($_POST['Content']))
		{
			...
			if($model->save()){
				if($_POST['Content']['orvos'] > ""){
					$this->llink=/*Yii::app()->request->baseUrl."/".$_POST['Content']['orvos'].*/"/admin/content/";} 
					else { $this->llink="";} 			

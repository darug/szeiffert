...
class Felvilagosit0Controller extends Controller
{
	/**
	...
	{
		$model=new Felvilagosit0;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Felvilagosit0']))
		{
			$model->attributes=$_POST['Felvilagosit0'];
	...
	{
		$dataProvider=new CActiveDataProvider('Felvilagosit0');
	 ...
	 * @return Felvilagosit0 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Felvilagosit0::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Felvilagosit0 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='felvilagosit0-form')
		{

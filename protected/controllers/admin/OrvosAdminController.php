<?php
/**
 * admin/OrvosAdminController
 * @class OrvosAdminController
 * 
 */
 
 /**
 * @brief admin/orvosAdmin => orvos tábla karbantartás
 * 
...
class OrvosAdminController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Orvos']))
		{
			$model->attributes=$_POST['Orvos'];

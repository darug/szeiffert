...
class Orvosform1Controller extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Orvosform1');
	 ...
	 * @return Orvosform1 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Orvosform1::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Orvosform1 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='orvosform1-form')
		{

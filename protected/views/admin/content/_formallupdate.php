...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<!--<div class="container">
	<div id="edit">-->
	<p class="red">Figyelem!!! A változásokat az összes nagyobb id-jű azonos name-mel rendelkező recordba átírja!!!</p>
	<?php echo $uzenet; 
	?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'title').$model->title; ?>
	...
	<div class="row"> -->
		<p class="red">A módosítást többszörösen ellenőriztem és a többi rekord módosítását engedélyezem(1):
			 <input type="text" name="Content[mehet]" id="content_mehet" size="1" maxlength="1" value="0" /></p>

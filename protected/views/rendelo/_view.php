...
if($_SESSION['ho']['orvos'] > 0)
	{$llink=Yii::app()->request->baseUrl."/".$_SESSION['ho']['orvos']."/rendelo";} 
else {$llink=Yii::app()->request->baseUrl;}
?>
		<tr>
				...
				<a title="Orvos(ok) kiíratása" href="<?php echo $llink; ?>/orvosok/id/<?php echo $data->id?>"><img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/admin/icon_edit.png" alt="Szerkesztés" /></a>

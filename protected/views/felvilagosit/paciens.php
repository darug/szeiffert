...
?> <form action="pacistat" method="post">
<input type="hidden" name="form" id="form" value="true" />
<?php
...
$insert="INSERT INTO `$db_tablanev_table` ($kulcs) VALUES ($ertek);";
 //  print($insert."<br>");
if($mysqli->query($insert)){print ("<B>Sikeres adatbevitel! Köszönjük a kitöltést!!!</B><br>DD Standard Kft");} else {
print("<font color=\"red\">Adatbázis kiírási hiba!!! ".$mysqli->errorno." </font><br>Köszönjük a kitöltést!<br>DD Standard Kft");}
?>
<br><br>

...
$eltext[]=text("orvosnev", "*Az orvos vezeték és kereszt neve","",100,"t","i","","")
;
$eltext[]=text("rend_irsz", "*A rendelő irányító száma:","",5,"t","i","","")
;
...
;
$eltext[]=text("megjegyn","Megjegyzés, egyéb javaslat","",200,"t","n","","")
;
$eltext[]=text("eletkor","*Az Ön életkora:","",4,n,i,18,110)
;

...
* text mező létrehozása
* @param string $name mező adatbázis oszlop neve
* @param string $label a beviteli mező előtt kiírt szöveg
* @param string $class itt nem hasznát, csak a stat függvénynél{t,n,u} 
*  t azaz text minden szöveget egymásalá kiírja, 
*  n aválaszok számát írja ki, 
*  u unique azonos válaszok számát írja ki. 
* @param string $fajta= {t,n,e} azaz text,number,email
*$kotelezo barmi, ha a mezo kitoltése kötelező, különben: '' !
* $min, $max, csak számnál és alsó és felső határértékellenőrzésnél kell megadni!
* @todo: n esetében a határérték figyelést meg kell oldani!!!
* @return ellenőrzia tartalmat és hibaesetén hibaüzenetet ad vissza-
*/

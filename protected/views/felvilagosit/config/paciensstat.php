...
<link href="<?php echo $rt; ?>default.css" rel="stylesheet" type="text/css" /> 
	...
	<script type="text/javascript" src="<?php echo $rt; ?>js/main.js"></script></head>
<body>
...
&nbsp </B></legend><font color="black"><b><center> Az adatvédelmi tájékoztató <a href=ddstandard.hu/adatvedelmi_nyilatkozat target=_blank> itt olvasható!</a> Kérdésekre adott válaszaikat előre is köszönjük! DD Standard Kft.<center></b>
</font></fieldset>
<fieldset>
...
$i=0;
echo Inputstat($eltext[$i]['name'],$eltext[$i]['label'],$eltext[$i]['class'],$db_tablanev_table);
?>
<br><?php
$i=1;
echo Inputstat($eltext[$i]['name'],$eltext[$i]['label'],$eltext[$i]['class'],$db_tablanev_table);
...
<br><?php
$i=0;
echo Radiostat($elsel[$i]['name'],$elsel[$i]['label'],$elsel[$i]['list'],$db_tablanev_table);
?>
<br></fieldset>
<fieldset>
...
&nbsp </B></legend><?php
$i=0;
echo Multicheckstat($elmul[$i]['name'],$elmul[$i]['label'],$elmul[$i]['list'],$db_tablanev_table);
?>
<br><?php
$i=4;
echo Inputstat($eltext[$i]['name'],$eltext[$i]['label'],$eltext[$i]['class'],$db_tablanev_table);

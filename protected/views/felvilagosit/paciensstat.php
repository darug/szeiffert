...
$i=0;
echo Inputunique1($eltext[$i]['name'],$eltext[$i]['label'],$eltext[$i]['class'],$db_tablanev_table,$mysqli);
?>
<?php
$i=1;
$namearray=array("0"=>"rend_irsz", "1"=>"rend_cim");
echo Inputunique1($namearray,'Rendelő',$eltext[$i]['class'],$db_tablanev_table,$mysqli);
?>
<?php /*
$i=2;
...
&nbsp </B></legend><?php
$i=5;
echo Inputatlag($eltext[$i]['name'],'Életkor',$eltext[$i]['class'],$db_tablanev_table,$mysqli);
?>
<?php
$i=1;
echo Radiostat($elsel[$i]['name'],$elsel[$i]['label'],$elsel[$i]['list'],$db_tablanev_table,$mysqli);

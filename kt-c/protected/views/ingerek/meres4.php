<?php
/*****************
 * Részletes eredmény kijelző oldal
 */
 ?>
<br> 
<!--<script src="https://code.highcharts.com/highcharts.js"></script>
<script src="https://code.highcharts.com/modules/exporting.js"></script> -->
<script type="text/javascript">	var $cim = "Darvas Gábor mérési eredményei"; </script>
<div id="container" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
<p><h4><center>Megjegyzés: a ki nem jelzett pontok nulla értéket jelentenek!</center></h4></p>
...
$(document).ready(function () {
    ...
    /*    subtitle: {
        ...
        xAxis: {
            ...
            categories: [<?php echo $ido; ?>],
             title: {
                text: 'Mérések időpontja'
             },
             minTickInterval:10
        },
        yAxis: {
